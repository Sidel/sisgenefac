...
import com.fabrica.sisgenefac.domain.XJsonItem;
...
public abstract class AbstractHandler {
     ...
     * @return
     */
    public static String getJsonSuccessData(List<? extends XJsonItem> results) {

        final JsonObjectBuilder builder = Json.createObjectBuilder();
        builder.add("success", true);
        final JsonArrayBuilder arrayBuilder = Json.createArrayBuilder();

        for ( XJsonItem ji : results ) {
     ...
     * @return
     */
    public static String getJsonSuccessData(XJsonItem jsonItem) {
        final JsonObjectBuilder builder = Json.createObjectBuilder();
        builder.add("success", true);
     ...
     * @return
     */
    public static String getJsonSuccessData(XJsonItem jsonItem, int totalCount) {
        final JsonObjectBuilder builder = Json.createObjectBuilder();
        builder.add("success", true);
