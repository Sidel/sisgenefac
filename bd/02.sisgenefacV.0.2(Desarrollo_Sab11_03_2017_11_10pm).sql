...
--
-- Servidor: localhost
-- Tiempo de generación: 12-03-2017 a las 04:09:22
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Para Reportes con DETALLE (por Curso y por Profesor).';
...
CREATE TABLE IF NOT EXISTS `reporte` (
  ...
  PRIMARY KEY (`rep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Ej.: Por profesor Nota Final = (Resultado 1 + Resultad';
